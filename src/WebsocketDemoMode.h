#ifndef WEBSOCKET_DEMO_MODE_H
#define WEBSOCKET_DEMO_MODE_H
...
public:
  WebsocketDemoMode() : lastWsSend(0), sendTimeout(60), sending(false) {}
  ~WebsocketDemoMode() {};
  ...
  void start() {
    ...
    hardware->display.print("Websocket Demo");
  }
